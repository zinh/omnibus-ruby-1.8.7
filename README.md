...
```shell
$ bin/omnibus clean ruby-1.8.7
```

Adding the `--purge` purge option removes __ALL__ files generated during the
build including the project install directory (`/opt/ruby-1.8.7`) and
the package cache directory (`/var/cache/omnibus/pkg`):

```shell
$ bin/omnibus clean ruby-1.8.7 --purge
```
...
[vagrant@ubuntu...] $ cd ruby-1.8.7
[vagrant@ubuntu...] $ bundle install
[vagrant@ubuntu...] $ ...
[vagrant@ubuntu...] $ bin/omnibus build ruby-1.8.7
```
